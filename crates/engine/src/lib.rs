...
pub use thread::{spawn_processing_thread, current_sample_rate, current_io_rate, set_io_rate, new_device_rates, new_scope_taps, DeviceRates, ProcessingOutput, ScopeTaps, ScopeTapRing, SinkBus, DEFAULT_SAMPLE_RATE, SCOPE_TAP_PINS, SCOPE_TAP_RETAIN_MS, SCOPE_TAP_MAX_LEN};

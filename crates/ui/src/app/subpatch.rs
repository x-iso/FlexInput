...
pub(crate) fn kbm_pin_label(pin: &str) -> String {
    match pin {
        ...
        "key_lshift" => "LShift".into(),
        "key_rshift" => "RShift".into(),
        "key_lctrl" => "LCtrl".into(),
        "key_rctrl" => "RCtrl".into(),
        "key_lalt" => "LAlt".into(),
        "key_ralt" => "RAlt".into(),
        "key_lwin" => "LWin".into(),
        "key_rwin" => "RWin".into(),
        "btn_paddle_l1" => "P1".into(),
        "btn_paddle_l2" => "P2".into(),
        "btn_paddle_r1" => "P3".into(),
        "btn_paddle_r2" => "P4".into(),
        "btn_misc1" => "M1".into(),
        "btn_misc2" => "M2".into(),
        "btn_misc3" => "M3".into(),
        "btn_misc4" => "M4".into(),
